...
@Component({
  selector: 'app-contact-by-contacttypereport',
  templateUrl: './contact-by-contacttypereport.component.html',
  styleUrls: ['./contact-by-contacttypereport.component.scss'],
  providers: [DatePipe]
})
export class ContactByContacttypereportComponent implements OnInit {
...
defaultColDef:ColDef={
 sortable: true,
  ...
  ngOnInit(): void {
    ...
    this.getContacatByContactTypeReport()
  ...
  getContacatByContactTypeReport() {
    
  
    this.reportservice.GetContacatByContactTypeReport(this.startDate, this.endDate, this.ContactTypeText).subscribe((res:any) => {
      console.log(res);
     this.RowData=res
    })
