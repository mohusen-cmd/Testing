...
@Component({
  selector: 'app-contactdetailreport',
  templateUrl: './contactdetailreport.component.html',
  styleUrls: ['./contactdetailreport.component.scss'],
  providers: [DatePipe]
})
export class ContactdetailreportComponent implements OnInit {
...
defaultColDef:ColDef={
 sortable: true,
  ...
  getContacatDetailReport() {
    

    this.reportservice.GetContacatDetailReport(this.startDate, this.endDate).subscribe((res: any) => {
     console.log(res)
   this.RowData=res
    })
