...
@Component({
  selector: 'app-contact-by-leadsourcereport',
  templateUrl: './contact-by-leadsourcereport.component.html',
  styleUrls: ['./contact-by-leadsourcereport.component.scss'],
  providers: [DatePipe]
})
export class ContactByLeadsourcereportComponent implements OnInit {
...
defaultColDef:ColDef={
 sortable: true,
  ...
  ngOnInit(): void {
    ...
    this.getContacatByLeadSourceReport()
  ...
  getContacatByLeadSourceReport() {

  

    this.reportservice.GetContacatByLeadSourceReport(this.startDate, this.endDate, this.LeadSourceText).subscribe((res:any) => {
      console.log(res)
      this.RowData = res
    })
