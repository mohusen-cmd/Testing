...
@Component({
  selector: 'app-companyindustryreport',
  templateUrl: './companyindustryreport.component.html',
  styleUrls: ['./companyindustryreport.component.scss'],
  providers:[DatePipe]
})
export class CompanyindustryreportComponent implements OnInit {
  ...
  endDate: any ;
  CompanyIndustryText: any='Select Value';
  ...
  columnDefs:ColDef[]=[
         ...
         {headerName:' Company Industry',field:'CompanyIndustryText'},
...
defaultColDef:ColDef={
 sortable: true,
  ...
  ngOnInit(): void {
    ...
    this.getCompanyIndustryReportDropdown()
  ...
  CompanyDetailsForm() {
    this.SignUpFrom = this.fb.group({
      ...
      CompanyIndustryText: new FormControl(this.CompanyIndustryText),
  ...
  getCompanyIndustryReportDropdown(){
    this.reportservice.GetCompanyIndustryReportDropdown().subscribe((res:any) => {
      console.log(res)
      this.drpList = res
    })
  }
  ...
  getCompanyIndustryReport() {
    ...
    this.reportservice.GetCompanyIndustryReport(this.startDate, this.endDate,this.CompanyIndustryText).subscribe((res:any) => {
      console.log(res)
      this.RowData = res
