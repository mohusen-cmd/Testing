...
@Component({
  selector: 'app-company-ownerreport',
  templateUrl: './company-ownerreport.component.html',
  styleUrls: ['./company-ownerreport.component.scss'],
  providers: [DatePipe]
})
export class CompanyOwnerreportComponent implements OnInit {
  ...
  gridOptions: GridOptions;
   columnDefs:ColDef[]=[
         {headerName:'Company Owner',field:'CompanyOwner'},   
...
defaultColDef:ColDef={
  ...
  ngOnInit(): void {
    ...
    this.getCompanyOwnerReportDropdown();
    this.getCompanyOwnerReport();
  ...
  getCompanyOwnerReportDropdown() {
    this.reportservice.GetCompanyOwnerReportDropdown().subscribe((res:any) => {
      console.log(res)
      this.drpList = res
    })
  }
  ...
  getCompanyOwnerReport() {
   
    this.reportservice.GetCompanyOwnerReport(this.startDate, this.endDate, this.Ownership).subscribe((res:any) => {
      console.log(res)
      this.RowData = res
    })
