...
@Component({
  selector: 'app-lead-by-lead-status-report',
  templateUrl: './lead-by-lead-status-report.component.html',
  styleUrls: ['./lead-by-lead-status-report.component.scss'],
  providers: [DatePipe]
})
export class LeadByLeadStatusReportComponent implements OnInit {
  ...
  endDate: any;
  myDate: any;
  BuyingStageText: any = 'Select Value';
  ...
  ngOnInit(): void {
    ...
    this.getLeadByLeadStatusReport()
  ...
  LeadDetailsForm() {
    this.SignUpFrom = this.fb.group({
      ...
      BuyingStageText: new FormControl(this.BuyingStageText),
  ...
  getLeadByLeadStatusReport() {
   
    this.as.getLeadByLeadStatusReport(this.startDate, this.endDate, this.BuyingStageText).subscribe(res => {
      console.log(res);
     this.rowData=res
